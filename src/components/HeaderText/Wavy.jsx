...
const Wavy = ({ textAlign, size }) => {
  const svgClass = classNames("absolute h-[41px] max-[620px]:w-[120px] -z-10", {
    "right-0 !bottom-[-47px]": size === "h1" && textAlign !== "text-center",
    "right-0 !bottom-[-39px]": size === "h2" && textAlign !== "text-center",
    "right-0 !bottom-[-37px]": size === "h3" && textAlign !== "text-center",

    // For center alignment, adjust positioning
    "left-1/2 transform -translate-x-1/2 !bottom-[-47px]":
      size === "h1" && textAlign === "text-center",
    "left-1/2 transform -translate-x-1/2 !bottom-[-39px] ":
      size === "h2" && textAlign === "text-center",
    "left-1/2 transform -translate-x-1/2 !bottom-[-37px]":
